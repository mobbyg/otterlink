...
void install(QApplication &app)
{
    app.setStyleSheet(QStringLiteral(R"STYLE(
        ...
        QPushButton#chatButton, QPushButton#boardsButton,
        ...
        QPushButton#chatButton:hover, QPushButton#boardsButton:hover,
        ...
        QPushButton#chatButton:pressed, QPushButton#boardsButton:pressed,
